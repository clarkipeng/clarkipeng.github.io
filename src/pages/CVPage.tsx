  ...
  <main className={`w-full grow ${pageBackground}`}>
    <section className={`${contentMeasure} py-12 sm:py-16`}>
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-4 text-xl leading-8 text-[#4f4f49] dark:text-[#d7d7d0]">
            A longer record of work, research, and projects.
          </p>
        </div>
      ...
      <section className="mt-12">
        <h2 className="font-sans text-2xl font-medium text-[#202020] dark:text-[#f5f5f2]">Experience</h2>
        <div className="mt-6">
          {experience.map((exp) => (
      ...
      <section className="mt-12">
        <h2 className="font-sans text-2xl font-medium text-[#202020] dark:text-[#f5f5f2]">Education</h2>
        <div className="mt-6">
          {education.map((edu) => (
      ...
      <section className="mt-12">
        <h2 className="font-sans text-2xl font-medium text-[#202020] dark:text-[#f5f5f2]">Leadership</h2>
        <div className="mt-6">
          {leadership.map((item) => (
      ...
      <section className="mt-12">
        <h2 className="font-sans text-2xl font-medium text-[#202020] dark:text-[#f5f5f2]">Skills</h2>
        <div className="mt-6">
